            ...
            <div className="mx-auto max-w-7xl py-2 px-4 sm:px-6 lg:px-8">
              <div className="mt-6 flex flex-wrap justify-center gap-8">
                <a
                  ...
                  className="flex h-16 w-56 justify-center grayscale transition hover:grayscale-0 focus:grayscale-0"
                >
                  <img alt="SimpleLocalize" src="/simplelocalize-logo.svg" className="object-contain" />
                </a>
                {[
                  {
